...
13. After the first run of the codepipeline, access the EC2 instance and change the conf of the codedeploy agent `:max_revisions: 2`. Then restart the codedeploy agent service.
